...
- **Цель проекта**: Найти и проехаться последовательно по цветным клеткам,по заранее заданной последовательности 4 цветов.

## Технические детали

- **Основные компоненты**:
  - Микроконтроллер ESP32
  - Датчики расстояния VL53L0X
...
4. Проверьте работу датчиков и ходовой робота.
